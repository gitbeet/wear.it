...
import type { ClientDataValidationType } from "../pagess/checkouts/CheckoutForm";
  ...
  return fancy ? (
    <div className="relative grow">
      ...
      <input
        ...
        } h-14 w-full rounded-full border bg-white pl-[72px] outline-none placeholder:text-slate-300 `}
    ...
    <div className="relative grow">
      ...
      <input
        autoFocus={autoFocus}
        className={`${
          error ? "border-red-500" : " border-slate-200 focus:border-indigo-300"
        } h-12 w-full rounded-sm border bg-white px-4 shadow-sm outline-none placeholder:text-slate-400`}
        placeholder={placeholder}
        id={name}
        type={type}
        {...register}
