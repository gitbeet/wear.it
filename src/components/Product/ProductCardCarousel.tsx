...
const CustomRightArrow = ({ onClick, ...rest }: ArrowProps) => {
  return (
    <div className="absolute right-0 flex -translate-x-full items-center justify-center rounded-full  bg-indigo-400 p-1 text-slate-50  ">
      <FiChevronRight
        className=" h-8 w-8 "
        role="button"
        onClick={() => onClick?.()}
...
const CustomLeftArrow = ({ onClick, ...rest }: ArrowProps) => {
  return (
    <div className="absolute left-0 flex translate-x-full items-center justify-center rounded-full  bg-indigo-400 p-1 text-slate-50  ">
      <FiChevronRight
